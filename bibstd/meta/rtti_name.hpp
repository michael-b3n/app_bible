...
struct __rtti_name_impl final
{
  static constexpr std::string_view value = []()
  {
    ...
    static constexpr std::string_view begin_pattern = "detail::__rtti_name_impl<";
    static constexpr auto name = std::string_view{__PRETTY_FUNCTION__};
#elif defined(_MSC_VER)
    static constexpr std::string_view begin_pattern = "detail::__rtti_name_impl<struct ";
    static constexpr auto name = std::string_view{__FUNCSIG__};
#endif
    static constexpr auto begin_pattern_pos__ = name.find(begin_pattern);
    static_assert(begin_pattern_pos__ != std::string_view::npos);
    static constexpr auto begin_pattern_pos = begin_pattern_pos__ + begin_pattern.size();
...
{
  static constexpr auto value = detail::__rtti_name_impl<T>::value;
};
