...
///
template<typename T>
concept string_view = std::is_same_v<T, std::string_view> || std::is_convertible_v<T, std::string_view>;
...
///
constexpr auto create_substring_view(const std::string_view& string_view, const std::size_t offset, const std::size_t size) -> std::string_view
{
